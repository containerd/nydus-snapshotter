/*
   ...
   This file is copied from https://github.com/containerd/containerd/blob/main/mount/losetup_linux.go with modifications.
...
type LoopParams struct {
	...
	Readonly bool
	// Loop device is automatically cleared by kernel when the last opener closes it
	Autoclear bool
